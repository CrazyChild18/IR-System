...
def prepare():
    ...
    # This algorithm can be used to get the root of a word
...
if __name__ == '__main__':
    ...
    # Index already exists and can be retrieved
        ...
        # Read the whole line (specify starting position 0)
        lines = f.readlines()[0:]
            ...
            if os.path.exists('output.txt') is False:
                ...
                with open(r'files/qrels.txt') as f:
                    ...
                    for line in f:
                        ...
                        # Before the query id changes, write data, and recreate query_relative
                        ...
                        # Consolidate the list of related documents with the same Query ID into the query_relative_list
